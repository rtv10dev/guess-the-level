...
const WordInfo = (props: Props) => {
  ...
  return (
    <div className="flex flex-col justify-self-center items-center break-all">
      <h1
        className="text-7xl font-semibold text-white capitalize max-sm:text-3xl text whitespace-nowrap break-normal"
      ...
      <h1 className="text-7xl font-semibold text-white capitalize max-sm:text-3xl text whitespace-nowrap">
        {type}
      </h1>
